...
When presenting the ranked list for user input, use `AskUserQuestion` (or numbered options with the top-ranked hypothesis as #1) per `~/.claude/injected-rules/question-format.md`.
